...
# Creating engine ti allow us to access and query our SQlite database fuke, 
...
# Defining welcome route or root  
@app.route("/")

# Creating a welcome funcition with a return statement
def welcome():
    return(
    '''
...
# Definining the precipitation route 
...
# Defining the Monthly Temperature route 
@app.route("/api/v1.0/tobs")

# Creating the Monthly Temperature function 
def temp_monthly():
    prev_year = dt.date(2017, 8, 23) - dt.timedelta(days=365)
